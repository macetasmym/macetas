...
fetch("data/data.json")
    ...
    .then(data=> {
        ...
        for (let i=0; i < 12; i++) {
            ...
            ///index.html
            if (window.location.pathname == (("/macetas2-v1.2/index.html") || ("/macetas/index.hmtl") || ("/macetas") || ("macetasmym.github.io/macetas/index.html"))) {
            ...
            //menu.html
            if (window.location.pathname == (("/macetas2-v1.2/menu.html") || ("/macetas/menu.html") || ("macetasmym.github.io/macetas/menu.html"))) {
                var arr = [0,3,11,1,6,7,2,4,5,9,8,10]
                var HTMLOptions = optionClass.item(i).firstElementChild;
                HTMLOptions.innerHTML = `$${data.Macetas[arr[i]].Price.NP - 0.01} - $${data.Macetas[arr[i]].Price.PD - 0.01}`;
                var HTMLDescription = detailBox.item(i).firstElementChild.nextElementSibling;
